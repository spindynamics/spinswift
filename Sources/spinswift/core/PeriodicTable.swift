...
/// A class for managing periodic table data and atomic properties.
///
/// This class enables looking up atomic numbers, symbols, names, and various physical properties
/// such as atomic mass and different types of atomic radii (empirical, calculated, and van der Waals).
///
/// - Author: Pascal Thibaudeau
/// - Date: 14/04/2023
/// - Version: 0.1
class PeriodicTable {
  /// Shared singleton instance for efficient access.
  @MainActor static let shared = PeriodicTable()
  ...
  */
  ...
  /// Mapping from element names/numbers to atomic symbols.
  ...
  /// Mapping from atomic numbers to atomic masses (in atomic units).
  ...
  /// Mapping from atomic numbers to empirical atomic radii (in picometers).
  ...
  /// Mapping from atomic numbers to calculated atomic radii (in picometers).
  ...
  /// Mapping from atomic numbers to van der Waals atomic radii (in picometers).
  ...
  /// Returns the atomic number for a given element name or symbol.
  /// - Parameter key: The element name or symbol.
  /// - Returns: The atomic number, or -1 if not found.
  func Z(_ key: String) -> Int {
    return Z_int[key.capitalized] ?? -1
  }

  /// Returns the atomic symbol for a given element name or atomic number.
  /// - Parameter key: The element name or atomic number.
  /// - Returns: The atomic symbol, or "Unknown" if not found.
  ...
  /// Returns the atomic mass for a given element name or symbol.
  /// - Parameter key: The element name or symbol.
  /// - Returns: The atomic mass in atomic units, or -1.0 if not found.
  func atomic_mass(_ key: String) -> Double {
    return atomic_mass[Z(key)] ?? -1.0
  }

  /// Returns the atomic radius for a given element and method.
  /// - Parameters:
  ///   - key: The element name or symbol.
  ///   - method: The method to use for the radius ("Empirical", "Calc", or "Vdw"). Defaults to "Empirical".
  /// - Returns: The atomic radius in picometers, or -1 if not found.
  func radius(_ key: String, method: String? = "Empirical") -> Int {
    switch method?.capitalized ?? "Empirical" {
    case "Vdw":
